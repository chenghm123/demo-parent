...
public class DataflowJobDemo implements DataflowJob<Object> {
    ...
    public static void main(String[] args) {
        ...
        // 定义作业核心配置
        JobCoreConfiguration coreConfig = JobCoreConfiguration.newBuilder("dataflowJobDemo", "0/15 * * * * ?", 4).build();
        // 定义SIMPLE类型配置
        DataflowJobConfiguration jobConfig = new DataflowJobConfiguration(coreConfig, DataflowJobDemo.class.getCanonicalName(), false);
        // 定义Lite作业根配置
